#> Veinmine the vein, reduce the durability of the tools and run the function again if the tool has enough durability
    ...
    #> Call the "gnottero:veinminer/events/veinmine/apply_damage/main" function
        execute if block ~ ~ ~ minecraft:nether_gold_ore unless entity @s[nbt={SelectedItem:{tag:{Unbreakable:1b}}}] run function gnottero:veinminer/events/veinmine/apply_damage/main
    ...
    #> Check the area for other blocks
        execute if predicate gnottero:veinminer/is_holding_pickaxe positioned ~ ~ ~1 if block ~ ~ ~ minecraft:nether_gold_ore run function gnottero:veinminer/events/veinmine/veinmine_ores/nether_gold_ore
        execute if predicate gnottero:veinminer/is_holding_pickaxe positioned ~ ~ ~-1 if block ~ ~ ~ minecraft:nether_gold_ore run function gnottero:veinminer/events/veinmine/veinmine_ores/nether_gold_ore
        execute if predicate gnottero:veinminer/is_holding_pickaxe positioned ~ ~1 ~ if block ~ ~ ~ minecraft:nether_gold_ore run function gnottero:veinminer/events/veinmine/veinmine_ores/nether_gold_ore
        execute if predicate gnottero:veinminer/is_holding_pickaxe positioned ~ ~-1 ~ if block ~ ~ ~ minecraft:nether_gold_ore run function gnottero:veinminer/events/veinmine/veinmine_ores/nether_gold_ore
        execute if predicate gnottero:veinminer/is_holding_pickaxe positioned ~1 ~ ~ if block ~ ~ ~ minecraft:nether_gold_ore run function gnottero:veinminer/events/veinmine/veinmine_ores/nether_gold_ore
