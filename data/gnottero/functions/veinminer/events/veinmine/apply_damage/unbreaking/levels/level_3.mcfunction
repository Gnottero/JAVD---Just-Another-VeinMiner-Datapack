#> Call the "gnottero:veinminer/unbreaking/level_3" predicate and if the result is 1 add 1 to the "" scoreboard value
    #> Called by the "gnottero:veinminer/events/veinmine/apply_damage/unbreaking/main" function

    #> Call the "gnottero:veinminer/unbreaking/level_3" predicate
        execute store result score #gn.random_chance gn.pick_dur if predicate gnottero:veinminer/unbreaking/level_3
